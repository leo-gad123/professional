          ...
          <div className="bg-card rounded-2xl md:rounded-3xl p-6 sm:p-10 md:p-16 card-shadow text-center relative overflow-hidden border border-border">
            ...
            <div className="grid gap-4 sm:gap-5 md:grid-cols-3 text-left mb-10">
              {contacts.map((c) => {
                ...
                return (
                  <div key={c.label} className="bg-secondary/60 rounded-xl p-4 sm:p-5 card-shadow">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {c.href ? (
                          <a href={c.href} className="text-sm text-foreground hover:text-primary transition-colors break-all">
                            {c.value}
                          </a>
                        ) : (
